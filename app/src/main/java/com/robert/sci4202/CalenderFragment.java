...
public class CalenderFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        RecyclerView recyclerView = view.findViewById(R.id.recviewCarlender);
        recyclerView.setLayoutManager(new LinearLayoutManager(view.getContext()));

        CalenderRecyclerviewAdapter calenderRecyclerviewAdapter = new CalenderRecyclerviewAdapter();

        ArrayList<CalenderItem> calenderItems = new ArrayList<>();
        calenderItems.add(new CalenderItem("Doc visi", "12-12-23", "12:00"));
        calenderItems.add(new CalenderItem("Doc visi", "12-12-23", "12:00"));
        calenderItems.add(new CalenderItem("Doc visi", "12-12-23", "12:00"));

        calenderRecyclerviewAdapter.setCalenderItems(calenderItems);
